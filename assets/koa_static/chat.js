...
$(document).ready(function(){
    ...
    if(window.mobileCheck()){
        ...
        var inputbox=$("<input>",{"id":"chatinput","onkeydown":"inputcheck(this)", "style":"height: 30px;background-color: #2f2f2f;border:0px;margin:10px;font-size: 14px;width: 260px;color:white;display: inline-block;"});
