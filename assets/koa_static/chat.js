...
$(document).ready(function(){
    ...
    if(window.mobileCheck()){
        ...
        var inputbox=$("<input>",{"id":"chatinput", "onkeydown":"limit(this)","onkeyup":"limit(this)", "style":"border-radius: 10px; padding: 2px 10px; background-color: #1b1b1d;border: 0px;margin: 10px;width: 66%;color: white;display: inline-block;float:right;font-size: 20px;"});
        ...
        var inputbox=$("<input>",{"id":"chatinput","onkeydown":"limit(this)","onkeyup":"limit(this)", "style":"height: 30px;background-color: #2f2f2f;border:0px;margin:10px;font-size: 14px;width: 200px;color:white;display: inline-block;"});
